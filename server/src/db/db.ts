...
('March Utilities', 160, 'Utilities', 0, '${thisYear}-03-05 15:30:00'),
('April Utilities', 155, 'Utilities', 0, '${thisYear}-04-05 15:30:00'),
('May Utilities', 165, 'Utilities', 0, '${thisYear}-05-05 15:30:00'),
('June Utilities', 170, 'Utilities', 0, '${thisYear}-06-05 15:30:00'),
('July Utilities', 180, 'Utilities', 0, '${thisYear}-07-05 15:30:00'),
('August Utilities', 175, 'Utilities', 0, '${thisYear}-08-05 15:30:00'),
('September Utilities', 160, 'Utilities', 0, '${thisYear}-09-05 15:30:00'),
('October Utilities', 150, 'Utilities', 0, '${thisYear}-10-05 15:30:00'),
('November Utilities', 155, 'Utilities', 0, '${thisYear}-11-05 15:30:00'),
('December Utilities', 145, 'Utilities', 0, '${thisYear}-12-05 15:30:00'),

('Furniture', 600, 'Home', 0, '${thisYear}-01-10 14:45:00'),
('Decor', 120, 'Home', 0, '${thisYear}-03-12 16:20:00'),
('Repair', 250, 'Home', 0, '${thisYear}-06-25 18:50:00'),
('Appliances', 450, 'Home', 0, '${thisYear}-09-18 13:30:00'),
('Cleaning Supplies', 90, 'Home', 0, '${thisYear}-11-22 11:15:00'),
...
('Weekly Groceries', 140, 'Groceries', 0, '${thisYear}-02-10 12:00:00'),
('Weekly Groceries', 155, 'Groceries', 0, '${thisYear}-04-05 12:00:00'),
('Special Ingredients', 60, 'Groceries', 0, '${thisYear}-06-12 12:00:00'),
('Holiday Groceries', 200, 'Groceries', 0, '${thisYear}-12-20 12:00:00'),

('Restaurant', 70, 'Dining', 0, '${thisYear}-01-22 19:00:00'),
('Coffee Shop', 15, 'Dining', 0, '${thisYear}-03-30 10:30:00'),
('Fast Food', 20, 'Dining', 0, '${thisYear}-05-15 13:15:00'),
('Dinner Date', 100, 'Dining', 0, '${thisYear}-08-20 20:00:00'),
('Lunch Outing', 40, 'Dining', 0, '${thisYear}-11-05 12:30:00'),

('Movie', 20, 'Leisure', 0, '${thisYear}-02-14 18:00:00'),
('Concert', 100, 'Leisure', 0, '${thisYear}-04-21 21:00:00'),
...
('Toys', 30, 'Pets', 0, '${thisYear}-05-18 14:00:00'),
('Grooming', 70, 'Pets', 0, '${thisYear}-08-25 16:00:00'),
('Pet Insurance', 25, 'Pets', 0, '${thisYear}-11-09 08:00:00'),

('Charity Donation', 100, 'Other', 0, '${thisYear}-01-20 12:00:00'),
